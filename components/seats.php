...
<div class="hall">
        ...
        <div class="inputForm">
        <center>
          Фільм:<p><strong><?php echo $movie["film_name"] ?></strong></p>
          Кількість місць: <input type="number" id="Numseats" min="1" max="120" value="0" readonly>
          Ціна: <input type="number" id="Sum" value="100" readonly>
          Час сеансу:<select size="1" id="movieTime">
            <option value="10:00">10:00</option>
            <option value="15:00">15:00</option>
            <option value="21:00">21:00</option>
          </select>
          Дата сеансу:<select size="1" id="movieDate">
            <option value="30.06.2021">30.06.2021</option>
            <option value="05.07.2021">05.07.2021</option>
            <option value="13.07.2021">13.07.2021</option>
          </select>
          <br><br>
          <!--<button onclick="takeData()">Почати вибір місць</button>-->
        </center>
        </div>
        ...
        <br/><button onclick="updateTextArea()">Купити</button>
        </center>
        </div>
        ...
        <center>
          ...
          <tr>
            <td><textarea id="film_id"><?php echo $_GET['id'] ?></textarea></td>
            <td><textarea id="id_user"><?php echo $_SESSION['userlogin']['id'] ?></textarea></td>
            <td><textarea id="film_name"><?php echo $movie["film_name"] ?></textarea></td>
            <td><textarea id="Time"></textarea></td>
            <td><textarea id="Date"></textarea></td>
            <td><textarea id="Cost"></textarea></td>
